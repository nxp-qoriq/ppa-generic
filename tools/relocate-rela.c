...
static void debug(const char *fmt, ...)
{
 ...
 // this function returns true if RELA type is R_AARCH64_RELATIVE:
static bool supported_rela(Elf64_Rela *rela)
{
 ...
 // this function swaps a 64 bit value
static inline uint64_t swap64(uint64_t val)
{
 ...
 // define be64 and le64 based on the byte order of the native machine
...
static bool read_num(const char *str, uint64_t *num)
{
 ...
 // this function statically applies the ELF rela relocations
